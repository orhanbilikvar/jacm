			...
			<ul>
				<?php foreach ($group as $item) : ?>
					<li class="onecikan<? $onecikan= $item->featured; echo $onecikan; ?>" >
                        ...
                        <?php $fullresim=$images->image_intro; ?>
                        <?php if (empty($fullresim)) : ?>
                        <?php else : ?>

                            <div class="mod-articles-category-image">
                                <a <?php echo $item->active; ?> href="<?php echo $item->link; ?>">
                                    <img class="image_intro" src="<?php echo $images->image_intro; ?>" alt="<?php echo $item->title; ?>"/> </a>
                            </div>
	...
	<?php else : ?>
		<?php foreach ($list as $item) : ?>
			<li class="onecikan<? $onecikan= $item->featured; echo $onecikan; ?>" >
                ...
                <?php if ($resim=="bos" ) : ?>
                    <div class="mod-articles-category-image <? echo "bos"; ?>">
                        <a <?php echo $item->active; ?> href="<?php echo $item->link; ?>">
